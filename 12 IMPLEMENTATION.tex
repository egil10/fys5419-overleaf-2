...
\begin{table}[H]
  \centering
  \small
  \caption{Datasets used throughout \cref{section:result}. The canonical $n=16$ instance is the concatenation of all four baskets; GOOGL appears in both \texttt{mag7} and \texttt{quantum\_big}, so the union contains 15 unique tickers and one duplicated column (kept intentionally so that each basket remains a self-contained 4-asset problem).}
  \label{tab:datasets}
  \begin{tabular}{@{}llrr@{}}
    \toprule
    ...
    \texttt{quantum\_big} & IBM, HON, GOOGL, NVDA     & 1006 & 2020-01 -- 2023-12 \\
